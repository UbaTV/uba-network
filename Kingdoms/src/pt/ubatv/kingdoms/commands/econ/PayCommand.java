            ...
            if(args.length == 2){
                ...
                try{
                    ...
                    if(balance < coins){
                        ...
                        player.sendMessage("§7You just sent §5" + coins + " §7" + main.textUtils.coinsSymbol + " to §5" + target.getName());
                        target.sendMessage("§7You just received §5" + coins + " §7" + main.textUtils.coinsSymbol+ " from §5" + player.getName());
                    }
