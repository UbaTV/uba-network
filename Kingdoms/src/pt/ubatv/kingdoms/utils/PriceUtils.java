...
public class PriceUtils {
    ...
    public int getPrice(Material mat){
        ...
        else if(mat.equals(Material.GHAST_TEAR)) return 250;
        else if(mat.equals(Material.GHAST_TEAR)) return 5;
        else if(mat.equals(Material.GHAST_TEAR)) return 50;
        else if(mat.equals(Material.GHAST_TEAR)) return 50;
        else if(mat.equals(Material.GHAST_TEAR)) return 50;
        else if(mat.equals(Material.GHAST_TEAR)) return 45;
        else if(mat.equals(Material.GHAST_TEAR)) return 32;
        else if(mat.equals(Material.GHAST_TEAR)) return 40;
        else if(mat.equals(Material.GHAST_TEAR)) return 43;
        return 999999999;
    }
